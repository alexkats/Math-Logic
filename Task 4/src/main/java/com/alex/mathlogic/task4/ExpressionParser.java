...
public class ExpressionParser {
    ...
    private Expression disjunction(String s) {
    ...
    private Expression conjunction(String s) {
    ...
    private void parseExpressionInBraces(Expression res) {
        res.terms = new ArrayList<>();
        do {
    ...
    private Expression summing(String s) {
    ...
    private Expression multiplier(String s) {
        Expression res = new Expression();
    ...
    private Expression variable(String s) {
        Expression res = new Expression();
        int i = 1;
        while (i < s.length() && s.charAt(i) > 47 && s.charAt(i) < 58) {
            i++;
